...
if __name__ == '__main__':
    # Parameters
    tsp_choco_database_path = "../../" + constants.PARAMETER_TSP_CHOCO_DATA_FILES
    number_cities = 10
    ...
    for model_ in Models:
        model_, precision_, accuracy_by_epochs_, valid_loss_by_epochs_, duplicates_by_epochs_ = \
            experiment(model_, epochs=nb_epochs, lr=learning_rate, train_set=train_data,
                       valid_set=valid_data, tsp_database_path=tsp_choco_database_path)
    ...
    test_accuracy = test(best_model_, test_data, tsp_choco_database_path)
    ...
    plt.savefig("../../" + constants.PARAMETER_FIGURE_RESULTS_PATH + "chocoLearning" + models_name + "_"
